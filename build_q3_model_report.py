...
RESULT = HERE / "result3_optimized.xlsx"
...
def build():
    ...
    marginal = metrics["marginal_update_value"]
    marginal_rows = [
        ["6:00", marginal["update_06_cost_saving"] / 1e4, marginal["update_06_emergency_reduction"]],
        ["12:00", marginal["update_12_cost_saving"] / 1e4, marginal["update_12_emergency_reduction"]],
        ["18:00", marginal["update_18_cost_saving"] / 1e4, marginal["update_18_emergency_reduction"]],
    ]
...
最终采用的四时刻分位数鲁棒 MPC 在 2025 年 2 月 1 日至 12 月 31 日的调整后购电费为 **{selected['scheduled_cost']:.2f} 元**，紧急购电费为 **{selected['emergency_cost']:.2f} 元**，总费用为 **{selected['total_cost']:.2f} 元**，紧急购电量为 **{selected['emergency_kwh']:.4f} kWh**。
...
{md_table(["新增更新时刻", "边际节省总费用/万元", "减少紧急购电量/kWh"], marginal_rows, [str, fmt4, fmt4])}
